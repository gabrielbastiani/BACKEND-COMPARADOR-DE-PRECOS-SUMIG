...
import { PagesStoreMachineCutProductService } from '../../services/products/PagesStoreMachineCutProductService';

class PagesStoreMachineCutProductController {
    async handle(req: Request, res: Response) {
        ...
        const storeProduct = new PagesStoreMachineCutProductService();
...
export { PagesStoreMachineCutProductController }